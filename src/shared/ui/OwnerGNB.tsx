...
export function OwnerGNB() {
  ...
  const navItems = [
    { name: "홈", path: "/owner/main", icon: "/icon/ownerGNB/home.svg" },
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[50] w-full max-w-[430px] mx-auto box-border bg-yellow-300 px-[27px] py-[18px] flex justify-between items-center shadow-[0px_-6px_14px_0px_rgba(47,47,47,0.04)]">
