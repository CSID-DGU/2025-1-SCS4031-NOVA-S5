...
export default function CafeRegisterModal({
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      <DialogContent className="p-0 bg-[#FFFDF7] w-[340px] h-[430px] gap-9">
        ...
        <div className="flex flex-col gap-[30px] items-center">
          <Image src={"/img/character/yellow-all.svg"} width={90} height={101} alt="character" />
        ...
        <DialogClose asChild>
          <button className="w-full h-[45px] border-t-[1px] border-t-[#8E8E9380] text-md text-font-green text-center font-semibold">
            확인
          </button>
        </DialogClose>
      </DialogContent>
