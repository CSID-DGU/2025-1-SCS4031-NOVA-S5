  ...
  return (
    <div className="w-[280px] h-[111px] bg-yellow-300 p-4 flex flex-col gap-4 justify-center items-center rounded-lg">
      <div className="flex justify-between gap-3 w-full h-[60px]">
        <img src="/img/coffee-cup.svg" alt="커피컵" width={60} height={60} className="bg-green-400 rounded-lg" />
        ...
        <img src="/icon/arrow-right.svg" alt="오른쪽화살표" width={20} height={20} className="cursor-pointer ml-5" />
      </div>
